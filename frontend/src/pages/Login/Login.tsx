        ...
        <div className='w-full p-6 rounded-lg shadow-md bg-gray-400 bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-0'>
            ...
            <form action="" onSubmit={formSubmitHandler}>
                <div>
                    ...
                    <input type="text" placeholder='Enter Username' className='w-full input input-border h-10 bg-black text-cyan-50' value={inputs.username} onChange={(e) => setInputs({...inputs, username:e.target.value})}/>
                </div>
                ...
                <div>
                    ...
                    <input type="password" placeholder='Enter Password' className='w-full  input input-border h-10 bg-black text-cyan-50' value={inputs.password} onChange={(e) => setInputs({...inputs, password:e.target.value})} />
                </div>
                ...
                <div>
                    <button className='btn btn-block btn-sm mt-2 bg-red-600 text-white border border-none'>{loading? "Loading..." : "Login"}</button>
                </div>
            </form>
        </div> 
    </div>
